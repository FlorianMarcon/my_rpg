...
menu_t	*suite_init_menu(menu_t *elem)
{
	...
	elem->texture8 = sfTexture_createFromFile("png_menu/check.png", NULL);
...
menu_t	*init_menu(void)
{
	...
	elem->texture = sfTexture_createFromFile("png_menu/play_on.png", NULL);
	elem->texture1 = sfTexture_createFromFile("png_menu/play_off.png", NULL);
	elem->texture2 = sfTexture_createFromFile("png_menu/quit_on.png", NULL);
	elem->texture3 = sfTexture_createFromFile("png_menu/quit_off.png", NULL);
	elem->texture4 = sfTexture_createFromFile("png_menu/setting_on.png", NULL);
	elem->texture5 = sfTexture_createFromFile("png_menu/setting_off.png", NULL);
	elem->texture6 = sfTexture_createFromFile("png_menu/bckl.png", NULL);
	elem->texture7 = sfTexture_createFromFile("png_menu/stars.png", NULL);
